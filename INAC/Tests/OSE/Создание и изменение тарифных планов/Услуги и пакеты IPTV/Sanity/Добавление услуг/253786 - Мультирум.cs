...
namespace INAC.Tests.OSE
{
    ...
    public class test_253786 : TestBase
    {
        ...
        public void step_03()
        {
            ...
            tl = IptvTechlists.FormIptvServicesInsertTechlist(Environment.TempCityId, Environment.TempCityName, "4",
                                                               serviceName, price);
        }
        ...
        public void step_07()
        {
            ...
            Assertion("Некорректное значение параметра (MULTIROOM) [ожидаемо: 1, актуально: " + list[3] + "]",
