...
namespace INAC.Tests.HD
{
    ...
    public class test_238002 : TestBase
    {
        ...
        public void step_01()
        {
            ...
            Assertion("ошибка подключения род. контроля, логин: " + login, () => Assert.IsFalse(dbRes.Count == 0));
        }
        ...
        public void step_02()
        {
            ...
            Assertion("некорректное отображение в БД расписания род. контроля, понедельник",
