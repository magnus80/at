...
namespace USSS.Tests.B2CPost
{
    [TestFixture]
    [Category("USSS_t")]
    public class ServiceManager : TestBase ///[1][B2C] Управление услугами B2C post (Sanity)
    {

        
        static string testName = "[1][B2C] Управление услугами B2C post(Sanity)";
        ...
        public void step_05()
        {
            ...
            string rezult = servicesPage.ConnectOfService(soc);
            if (rezult != "success")
            {
                Logger.PrintRezult(false, rezult);
                globalR = false;
        ...
        public void step_11()
        {
            ...
            rezult = "";
            //  Заявка №2147677554 от 13.05.2015 16:57 на отключение пакета услуг GPRS-пакет в международном роуминге 100 Мб для абонента 9030339107 обработана. Изменения вступят в силу . https://my.beeline.ru
