...
namespace INAC.Tests.OSE
{
    ...
    public class test_253785 : TestBase
    {
        ...
        public void step_03()
        {
            ...
            tl = IptvTechlists.FormIptvServicesInsertTechlist(Environment.TempCityId, Environment.TempCityName, "3",
                                                               serviceName, price);
        }
        ...
        public void step_07()
        {
            var query =
                ...
                s_id + "' and param_name = 'IPTV_RENT_MODE_2'";
