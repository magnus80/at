...
namespace USSS.Tests.Regression.B2B
{
    [TestFixture]
    [Category("USSS")]
    class BlockUser : TestBase
    {
        static string testName = "[B2B] Блокировка абонента B2B";

        string login = ReaderTestData.GetXMLTestData("BlockUser/login");
        string password = ReaderTestData.GetXMLTestData("BlockUser/password");
        string ban = ReaderTestData.GetXMLTestData("BlockUser/ban");
        string phoneNumber = ReaderTestData.GetXMLTestData("BlockUser/phoneNumber");
        ...
        public void step_02()
        {
            ...
            managerContractPage.UnlockNumberInDataBase(ban, phoneNumber);
            ...
            else
            {
                ...
                Logger.PrintRezult(true, "Абонент заблокирован");
            }
        }
