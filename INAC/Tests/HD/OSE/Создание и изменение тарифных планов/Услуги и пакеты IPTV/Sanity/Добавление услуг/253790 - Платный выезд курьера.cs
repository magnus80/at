...
namespace INAC.Tests.OSE
{
    ...
    public class test_253790 : TestBase
    {
        ...
        public void step_03()
        {
            ...
            tl = IptvTechlists.FormIptvServicesInsertTechlist(Environment.TempCityId, Environment.TempCityName, "9",
                                                               serviceName, price);
        }
        ...
        public void step_07()
        {
            var query =
                ...
                s_id + "' and param_name = 'IPTV_DISCONNECT'";
            ...
            Assertion("Некорректное значение параметра (IPTV_DISCONNECT) [ожидаемо: 1, актуально: " + list[3] + "]",
