...
namespace INAC.Tests.OSE
{
    ...
    public class test_253766 : TestBase
    {
        ...
        public void step_03()
        {
            ...
            price ="0";
            tl = IptvTechlists.FormIptvServicesInsertTechlist(Environment.TempCityId, Environment.TempCityName, "0",
                                                               serviceName, price);
        }
        ...
        public void step_07()
        {
            var query =
                ...
                s_id + "' and param_name = 'IPTV_CAPSULE'";
            ...
            Assertion("Некорректное значение параметра (IPTV_CAPSULE) [ожидаемо: 1, актуально: " + list[3] + "]",
