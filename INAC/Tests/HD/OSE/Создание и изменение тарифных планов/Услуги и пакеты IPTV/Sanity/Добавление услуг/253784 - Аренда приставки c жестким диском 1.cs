...
namespace INAC.Tests.OSE
{
    ...
    public class test_253784 : TestBase
    {
        ...
        public void step_03()
        {
            ...
            tl = IptvTechlists.FormIptvServicesInsertTechlist(Environment.TempCityId, Environment.TempCityName, "2",
                                                               serviceName, price);
        }
        ...
        {
            var query =
                "select s_name, s_price, s_f_iptv from inac.services join inac.services_param on s_id = id_service where s_id = '" +
                s_id + "' and param_name = 'IPTV_RENT_MODE_1'";
            ...
            Assertion("Некорректный параметр сервиса (s_f_iptv) [ожидаемо: 1, актуально: " + list[2] + "]",
