...
namespace INAC.Tests.OSE
{
    ...
    public class test_253789 : TestBase
    {
        ...
        public void step_03()
        {
            ...
            tl = IptvTechlists.FormIptvServicesInsertTechlist(Environment.TempCityId, Environment.TempCityName, "8",
                                                               serviceName, price);
        }
        ...
        public void step_07()
        {
            var query =
                ...
                s_id + "' and param_name = 'IPTV_CONNECT'";
            ...
            Assertion("Некорректное значение параметра (IPTV_CONNECT) [ожидаемо: 1, актуально: " + list[3] + "]",
