...
namespace USSS.Tests.RestAPI
{
    ...
    {
        private static readonly string testName = "[Rest API] serviceActivate FREEMIUM";
        ...
        private readonly string ctn = ReaderTestData.ReadExel(testName, "ctn");
        ...
        public void step_01_02()
        {
            ...
            //ServiceActivate.serviceActivate(ctn);
